...
- `ffmpeg libsm6 libxext6` were installed because of the `cv2` dependency. This can be removed after [#239](https://github.com/prism-oncology/sopa/pull/239) is merged, as it will remove the `cv2` dependency.
