...
def cosmx(
    ...
    Args:
        ...
        flip_image: For some buggy exports of AtomX 1.3.2, `flip_image=True` has to be used for stitching. See [this](https://github.com/prism-oncology/sopa/issues/231) issue.
