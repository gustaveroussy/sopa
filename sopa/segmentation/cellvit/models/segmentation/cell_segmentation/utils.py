...
from sopa.segmentation.cellvit.models.encoders.VIT import (
    ImageEncoderViTSAM,
    VisionTransformer,
)
...
class Conv2DBlock(nn.Module):
    ...
    def __init__(
        self, in_channels: int, out_channels: int, kernel_size: int = 3, dropout: float = 0,
    ) -> None:
        super().__init__()
...
class ViTCellViTDeit(ImageEncoderViTSAM):
    def __init__(
        self,
        extract_layers: List[int],
        img_size: int = 1024,
